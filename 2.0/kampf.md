...
### Symbole:
    ...
    ↩️🟪 1 verbrauchter 🟪 wird wiederhergestellt(Defensivskill)
...
Jeder Knoten kostet 1 Punkt(außer anders angegeben) & Erfordert alle Elternkoten.
    ...
    | |  + Beinarbeit: 🟪
    | |    + Ausweichmeister: +⚔️(🛡️)
    | + Mittlere Rüstung(Leder/Kette): 🟦; Energielimit -1; kein -⛈️(🛡️)
    | | + Gewöhnung: 🟦
    | |   + Meisterung: Energielimit normal
    | + Schwere Panzerung(Harnisch/...): +⛈️(🛡️); 🟦; -⚔️(🛡️); Energielimit -2
